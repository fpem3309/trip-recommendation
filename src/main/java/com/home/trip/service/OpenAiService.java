...
public class OpenAiService {
    ...
    public String getTravelRecommendation(String userPrompt) {
        ...
        return "{\n" +
                ...
                "  \"itinerary\": [\n" +
                "    {\"day\": 1, \"plan\": \"교토 도착 후 기온 거리 산책 및 야사카 신사 방문\"},\n" +
                "    {\"day\": 2, \"plan\": \"아라시야마 대나무 숲, 도게츠교, 원숭이 공원 탐방\"},\n" +
                "    {\"day\": 3, \"plan\": \"금각사, 은각사, 철학의 길 투어\"},\n" +
                "    {\"day\": 4, \"plan\": \"후시미 이나리 신사에서 1만 개 도리이 체험 후 교토역 쇼핑\"},\n" +
                "    {\"day\": 5, \"plan\": \"니조성 관람 후 귀국\"}\n" +
                "  ],\n" +
